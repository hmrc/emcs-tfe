...
class SubmitCancellationOfMovementControllerIntegrationSpec extends IntegrationBaseSpec with SubmitCancellationOfMovementFixtures with FeatureSwitching {
