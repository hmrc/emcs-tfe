...
import uk.gov.hmrc.emcstfe.models.changeOfDestination._
import uk.gov.hmrc.emcstfe.models.common.{DestinationType, TransportArrangement}

import scala.xml.Elem

trait SubmitChangeOfDestinationFixtures extends BaseFixtures with ChRISResponsesFixture {
  ...
  object SubmitChangeOfDestinationFixtures {
    ...
    lazy val submitChangeOfDestinationModelMax: SubmitChangeOfDestinationModel = SubmitChangeOfDestinationModel(
    ...
    lazy val submitChangeOfDestinationModelMin: SubmitChangeOfDestinationModel = SubmitChangeOfDestinationModel(
    ...
    lazy val submitChangeOfDestinationXmlMax: Elem = <urn:ChangeOfDestination>
      {attributesXmlMax}
    ...
    lazy val submitChangeOfDestinationXmlMin: Elem = <urn:ChangeOfDestination>
      {attributesXmlMin}
      {updateEadEsadXmlMin}
      {destinationChangedXmlMin}
    </urn:ChangeOfDestination>

    lazy val submitChangeOfDestinationJsonMax: JsObject = Json.obj(
    ...
    lazy val submitChangeOfDestinationJsonMin: JsObject = Json.obj(
