...
trait GetMovementIfChangedFixture extends BaseFixtures with TraderModelFixtures {
  ...
  lazy val getMovementIfChangedNoChangeSoapWrapper: String =
    """<tns:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:tns="http://www.w3.org/2003/05/soap-envelope">
      |  <tns:Body>
  ...
  def getMovementIfChangedWithChangeSoapWrapper(sequenceNumber: Int = 1): String =
    s"""<tns:Envelope
