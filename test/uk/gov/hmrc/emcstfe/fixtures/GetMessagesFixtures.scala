...
import uk.gov.hmrc.emcstfe.models.response.getMessages.{GetMessagesResponse, Message, MessagesData, RawGetMessagesResponse}
...
trait GetMessagesFixtures extends BaseFixtures {
  ...
  object MessagesDataFixtures {
    ...
    val messagesDataModel: MessagesData = MessagesData(
      messages = Seq(
    ...
    val messagesDataMinimumModel: MessagesData = MessagesData(messages = Seq(), totalNumberOfMessagesAvailable = 0)

    val messagesDataJson: JsValue = Json.obj(
    ...
    val messagesDataMinimumJson: JsValue = Json.obj("messages" -> JsArray(Seq()), "totalNumberOfMessagesAvailable" -> 0)
  }
