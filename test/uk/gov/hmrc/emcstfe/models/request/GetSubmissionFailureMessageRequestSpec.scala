...
class GetSubmissionFailureMessageRequestSpec extends TestBaseSpec {

  val request = GetSubmissionFailureMessageRequest(testErn, testMessageId)
  ...
  "action" should {
    "be correct" in {
      request.action shouldBe "http://www.govtalk.gov.uk/taxation/internationalTrade/Excise/EMCSApplicationService/2.0/GetSubmissionFailureMessage"
    }
  }
  ...
  "queryParams" should {
    "return the ERN and MessageId as a query param" in {
