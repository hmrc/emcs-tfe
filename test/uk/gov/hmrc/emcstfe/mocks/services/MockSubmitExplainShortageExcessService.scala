...
trait MockSubmitExplainShortageExcessService extends MockFactory  {

  lazy val mockService: SubmitExplainShortageExcessService = mock[SubmitExplainShortageExcessService]

  object MockService extends Matchers {
    def submitViaEIS(submission: SubmitExplainShortageExcessModel): CallHandler4[SubmitExplainShortageExcessModel, HeaderCarrier, ExecutionContext, UserRequest[_], Future[Either[ErrorResponse, EISSubmissionSuccessResponse]]] =
