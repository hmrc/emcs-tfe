...
class ReportReceiptUserAnswersServiceSpec extends BaseUserAnswersServiceSpec {

  override val mockRepo: ReportReceiptUserAnswersRepository = mokitoMock[ReportReceiptUserAnswersRepository]
