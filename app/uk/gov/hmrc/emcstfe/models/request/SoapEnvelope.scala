...
trait SoapEnvelope { _: ChrisRequest =>
  def envelope[T <: XmlBaseModel](body: T,
                                  messageNumber: Int,
                                  messageSender: String,
                                  messageRecipient: String)(implicit request: UserRequest[_]): NodeSeq =
    XML.loadString(s"""<soapenv:Envelope xmlns:soapenv="http://www.w3.org/2003/05/soap-envelope">
      |  <soapenv:Header>
