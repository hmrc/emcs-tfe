...
import uk.gov.hmrc.emcstfe.repositories.ExplainShortageOrExcessUserAnswersRepository.mongoIndexes
...
@Singleton
class ExplainShortageOrExcessUserAnswersRepository @Inject()(mongoComponent: MongoComponent,
                                                             appConfig: AppConfig,
                                                             time: TimeMachine
                                                            )(implicit ec: ExecutionContext)
  extends PlayMongoRepository[ExplainShortageOrExcessUserAnswers](
    collectionName = "explain-shortage-or-excess-user-answers",
    mongoComponent = mongoComponent,
    domainFormat = ExplainShortageOrExcessUserAnswers.format,
    indexes = mongoIndexes(appConfig.explainShortageOrExcessUserAnswersTTL()),
  ...
  def get(ern: String, arc: String): Future[Option[ExplainShortageOrExcessUserAnswers]] =
  ...
  def set(answers: ExplainShortageOrExcessUserAnswers): Future[Boolean] = {
...
object ExplainShortageOrExcessUserAnswersRepository {
