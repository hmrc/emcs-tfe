...
@Singleton
class ChangeDestinationUserAnswersRepository @Inject()(mongoComponent: MongoComponent,
                                                       appConfig: AppConfig,
                                                       time: TimeMachine
                                                      )(implicit ec: ExecutionContext)
  extends PlayMongoRepository[ChangeDestinationUserAnswers](
  ...
  def get(ern: String, arc: String): Future[Option[ChangeDestinationUserAnswers]] =
  ...
  def set(answers: ChangeDestinationUserAnswers): Future[Boolean] = {
